...
public class AutoPolicyMod {
    ...
    // constructor
    public AutoPolicyMod(int accountNumber, String makeAndModel,
                      String state) {
    ...
    public void setState(String state) {
        ...
        if(state == "MA" || state == "NJ"|| state == "NY" || state == "PA" || state == "CT" || state == "ME" ||
                state == "VT" || state == "NH") this.state = state;
        else System.out.println("Złe oznaczenie stanu");
    }
    ...
    public boolean isNoFaultState(){
        ...
        switch (getState()) { // get AutoPolicy object's state abbreviation
            case "MA": case "NJ": case "NY": case "PA": case "CT": case "ME": case "VT": case "NH":
                noFaultState = true;
                break;
            default:
                noFaultState = false;
